...
import { addProduct } from "../../services/redux/products/productSlice";
...
const Form = () => {
  ...
  const handleSubmitForm = (e) => {
    ...
    dispatch(addProduct({ no: crypto.randomUUID(), name: prodName, category, image: filePath, freshness, description, price }));
